...
const Structure = () => {
  return (
    ...
    >
      <div className="justify-items-end absolute right-0 top-24 md:top-20  z-10 hidden md:block">
  ...
  {/* LEFT CARD COLUMN */}
  <div className="w-full lg:w-5/12 space-y-4 sm:space-y-6 order-2 lg:order-1">
    {DataCard1.map((item) => (
      <div
        key={item.id}
  ...
  {/* CENTER IMAGE */}
  <div className="w-full sm:w-auto lg:w-2/12 flex justify-center order-1 lg:order-2 mb-6 sm:mb-8 lg:mb-0 px-4">
    <img 
      src={StructureImg} 
      alt="Structure" 
  ...
  {/* RIGHT CARD COLUMN */}
  <div className="w-full lg:w-5/12 space-y-4 sm:space-y-6 order-3">
    {DataCard2.map((item) => (
      <div
        key={item.id}
